...
const JA = {
  ...
  freeQuery: '検索',
  freeQueryPlaceholder: '技名・コマンド・数値など',
  moveName: '技名',
  ...
  partialSuffix: ' (部分一致)',
  compareHint: '表の技名をクリックすると、全キャラで同じ技を比較できます',
  filterTitle: '条件検索',
  resultCount: '{count}件',
...
const EN: Record<MessageKey, string> = {
  ...
  freeQuery: 'Search',
  freeQueryPlaceholder: 'Move, command, numbers…',
  moveName: 'Move',
  ...
  compareHint: 'Click a move name in the table to compare it across all characters',
  filterTitle: 'Filter',
  ...
  colAttackAttribute: 'attack attribute',
  colNotes: 'notes',
